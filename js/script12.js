...
function scrollFunction1() {
    ...
    list_link = document.querySelectorAll(".my-list-link,.my-logo-text,.bx-store,.fa-magnifying-glass");

    if (document.body.scrollTop > 30 || (document.documentElement.scrollTop > 30)) {
        document.querySelector(".my-nav").style.backgroundColor = "white";
        list_link.forEach(function (list_link) {
            list_link.style.color = "#525252";
        });
